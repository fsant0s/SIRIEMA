...
class MultimodalDataTrainingArguments:
    ...
    vae_dropout: float = field(default=0.1,
                               metadata={
    ...
    vae_act: str = field(default='relu',
                         metadata={
                             'help': 'the activation function to use for finetuning layers',
                             'choices': ['relu', 'prelu', 'sigmoid', 'tanh', 'linear']
                         })
    ...
    num_random_samples: int = field(default=0,
                            metadata={'help': 'number of samples to train, val, and test the model.'
                                      'To use the whole dataset set it to zero'}
    )
